...
class AgentDefaults(Base):
    ...
    consolidation_max_tokens: int = 16384  # Max tokens for memory consolidation output
...
class NetworkSecurityConfig(Base):
    """Network security policy for tools that may access URLs."""
